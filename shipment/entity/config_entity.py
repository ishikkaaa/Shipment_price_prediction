...
#This DataIngestionConfig class sets up all the paths and configuration settings needed for the data ingestion step in a machine learning or data pipeline project.
@dataclass
